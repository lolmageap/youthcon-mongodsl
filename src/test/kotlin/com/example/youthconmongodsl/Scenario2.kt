...
//    @Test
//    @DisplayName("대소문자 구분 없이 별명에 hy가 포함되고 나이가 30살 이상인 저자를 나이가 많은 순으로 조회한다 to be")
//    fun toBe() {
//        val query =
//            where {
...
//    }
//
//    infix fun KProperty<*>.greaterThanEqual(
//        value: Any,
//    ): Criteria {
//        val criteria = Criteria(this.toDotPath()).gte(value)
//        criteriaList.add(criteria)
//        return criteria
//    }
//
...
//    }
//
//    infix fun KProperty<*>.size(
//        value: Int,
//    ): Criteria {
//        val criteria = Criteria(this.toDotPath()).size(value)
//        criteriaList.add(criteria)
//        return criteria
//    }
//}
